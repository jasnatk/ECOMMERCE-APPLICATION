...
export const Home = () => {
  ...
  const itemsPerPage = 5; // Updated to 5 to match 5 products per row
  ...
  const topFiveProducts = products.slice(2, 7); // Adjusted to fetch 5 products
  const newArrivalsAll = products.slice(-10); // Adjusted to fetch more products for pagination
