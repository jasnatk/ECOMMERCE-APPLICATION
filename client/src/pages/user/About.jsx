...
const Testimonials = () => {
  ...
  return (
    <section className="w-full py-8 max-w-7xl mx-auto px-4 sm:px-16 bg-white">
      <h2 className="text-xl sm:text-2xl font-bold text-center mb-6 tracking-tight text-black">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {reviews.map((review, index) => (
          <div
            key={index}
            className="p-4 border border-black rounded-lg shadow-sm hover:shadow-md transition bg-white"
          >
            <p className="text-sm italic mb-2 text-black">"{review.text}"</p>
