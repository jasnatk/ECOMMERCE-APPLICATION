        ...
        <div className="flex items-center justify-center bg-base-200 py-24 min-h-screen">
            <div className=" shadow-2xl rounded-lg flex flex-col lg:flex-row w-full max-w-4xl overflow-hidden">
                ...
                <div className="w-full lg:w-1/2 p-8 flex flex-col justify-center items-center space-y-6">
                    ...
                    <p className="text-center font-medium text-teal-500">Z Fashion - Your Ultimate Fashion Destination</p>
                    <form className="flex flex-col items-center space-y-4 w-full" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input type="text" placeholder="PhoneNumber" {...register("phoneNumber", { required: "Phone number is required" })} 
